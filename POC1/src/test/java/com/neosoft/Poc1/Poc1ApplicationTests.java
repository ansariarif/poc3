...
public class Poc1ApplicationTests {
	...
	User RECORD_1 = new User(1, "Arif", "Ansari", (long) 401209, new Date(2021 - 8 - 11), new Date(2003 - 12 - 10),
			"Arif@gmail.com", "Arif", (long) 832972048,"yes");
	User RECORD_2 = new User(2, "Pankaj", "Kori", (long) 401209, new Date(2021 - 8 - 11), new Date(2000 - 11 - 23),
			"Pankaj3@gmail.com", "Pankaj", (long) 832972048,"yes");
	User RECORD_3 = new User(3, "messi", "lional", (long) 401209, new Date(2022 - 8 - 11), new Date(2021 - 11 - 23),
			"messi@gmail.com", "messi", (long) 832972048,"yes");
	...
	public void getAllRecords_success() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/users").contentType(MediaType.APPLICATION_JSON))
				...
				.andExpect(jsonPath("$", hasSize(3))).andExpect(jsonPath("$[2].name", is("messi")));
	}
	...
	public void getUsersByName_success() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/usersbyname/Arif").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk()).andExpect(jsonPath("$", notNullValue()))
	...
	public void getUsersBySurname_success() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/usersbysurname/Ansari").contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk()).andExpect(jsonPath("$", notNullValue()))
				.andExpect(jsonPath("$[0].surname", is("Ansari")));
	}
