...
public class UserService {
	...
	public List<User> getAllUsers(){
		return accountRepository.findAll().stream().filter(u -> u.getActive().equals("yes")).collect(Collectors.toList());
	}
...
//					compareTo(o2.getDoj())).collect(Collectors.toList());
	...
	public void softDeleteUser(String status,int id) {
		accountRepository.deleteStatus(status, id);
	}
